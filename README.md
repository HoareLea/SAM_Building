[![Build (Windows)](https://github.com/SAM-BIM/SAM_Building/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/SAM-Building/SAM_BHoM/actions/workflows/build.yml)


# SAM_Building - Not in use - 
