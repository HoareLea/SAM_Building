...
{
    public class Profile : SAMObject, IBuildingObject
    {
        ...
        public Profile(string name, ProfileType profileType)
            : base(name)
        {
            category = profileType.Description();
        }

        public Profile(string name, ProfileGroup profileGroup)
            : base(name)
        {
            category = profileGroup.Description();
        }
