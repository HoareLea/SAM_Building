...
{
    public class BuildingModel : SAMModel, IBuildingObject
    {
        ...
        public Zone GetZone(string name, ZoneType zoneType)
        {
            ...
            string zoneTypeText = zoneType.Description();
        ...
        public bool Transparent(IPartition partition)
        {
            ...
            {
                return Core.Building.Query.Transparent(((IHostPartition)partition).Type(), materialLibrary);
            }
        ...
        public bool Transparent(HostPartitionType hostPartitionType)
        {
            ...
            return Core.Building.Query.Transparent(hostPartitionType, materialLibrary);
        }
